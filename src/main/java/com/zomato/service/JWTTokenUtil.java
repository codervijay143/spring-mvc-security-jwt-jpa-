...
public class JWTTokenUtil {
	// Token Creation : JWT API
		...
		// 3. Expired time : 3 Mints
	private long expMilliSeconds=3*60000;
	private final String SECRET_KEY="NJCXSCSKSNNSVKXVNMNNJCNSMJBCBSJCBSJNJCXSCSKSNNSVKXVNMNNJCNSMJBCBSJCBSJNJCXSCSKSNNSVKXVNMNNJCNSMJBCBSJCBSJ";
...
public String getUserNameFromToken(String token) {
	String tokenUserName=Jwts.parser().setSigningKey(SECRET_KEY).parseClaimsJws(token)
	.getBody().getSubject();
